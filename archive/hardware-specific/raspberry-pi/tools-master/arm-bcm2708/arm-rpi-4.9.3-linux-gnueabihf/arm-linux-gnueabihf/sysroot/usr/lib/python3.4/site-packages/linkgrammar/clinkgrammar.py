...
def linkgrammar_get_dict_version(*args) -> "char const *" :
...
def linkgrammar_get_dict_locale(*args) -> "char const *" :
...
def dictionary_get_lang(*args) -> "char const *" :
...
def parse_options_get_verbosity(*args) -> "int" :
...
def parse_options_set_linkage_limit(*args) -> "void" :
...
def parse_options_get_linkage_limit(*args) -> "int" :
...
def parse_options_set_min_null_count(*args) -> "void" :
...
def parse_options_get_islands_ok(*args) -> "int" :
...
def parse_options_set_max_memory(*args) -> "void" :
...
def parse_options_get_max_memory(*args) -> "int" :
...
def parse_options_set_max_parse_time(*args) -> "void" :
...
def parse_options_set_cost_model_type(*args) -> "void" :
...
def parse_options_get_cost_model_type(*args) -> "Cost_Model_type" :
...
def parse_options_set_display_morphology(*args) -> "void" :
...
def parse_options_get_display_morphology(*args) -> "int" :
...
def parse_options_set_all_short_connectors(*args) -> "void" :
...
def parse_options_set_use_sat_parser(*args) -> "void" :
...
def parse_options_get_use_sat_parser(*args) -> "int" :
...
def sentence_num_linkages_post_processed(*args) -> "int" :
...
def linkage_print_senses(*args) -> "char *" :
...
def linkage_get_link_num_domains(*args) -> "int" :
...
def linkage_get_link_domain_names(*args) -> "char const **" :
...
def linkage_get_word_char_end(*args) -> "int" :
...
def linkage_disjunct_cost(*args) -> "double" :
