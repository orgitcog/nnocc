...
CHATBOT_SERVER_URL = os.environ.get('CHATBOT_SERVER_URL', 'http://localhost:8002')
URL_PREFIX = os.environ.get('URL_PREFIX', "http://localhost:8002")
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--port', default='8002', help='Port string of chatbot server')
    parser.add_argument(
