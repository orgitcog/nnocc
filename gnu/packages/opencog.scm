  ...
  (let ((commit "86c848dfc7135b3c47deb581f8da54a60f6711c9")
    ...
    (package
      ...
      (arguments
       (list
        #:configure-flags
        #~(list (string-append "-DGUILE_INCLUDE_DIR=" #$guile-3.0
                               "/include/guile/3.0/")
              ...
              (lambda* (#:key tests? #:allow-other-keys #:rest args)
                (when tests?
                  ...
                  (for-each invoke
                            (find-files "tests" "UTest$"))))))))
      (inputs
       (list boost cogutil gmp guile-3.0 postgresql))
      (native-inputs
       (list cxxtest
             python-minimal
             pkg-config))
              ...
              (lambda* (#:key tests? #:allow-other-keys #:rest args)
                (when tests?
                  ...
                  (for-each invoke
                            (find-files "tests" "UTest$"))))))))
      (inputs
       (list atomspace boost cogutil gmp guile-3.0))
      (native-inputs
       (list cxxtest
             python-minimal
             pkg-config))
...
(define-public agi-bio
  ...
  (let ((commit "b5c6f3d99e8cca3798bf0cdf2c32f4bdb8098efb")
    ...
    (package
      ...
      (inputs
       (list atomspace cogutil gmp guile-3.0))
      (native-inputs
       (list cxxtest
             python-minimal
             pkg-config))
