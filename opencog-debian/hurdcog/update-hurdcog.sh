#!/bin/bash
#
# Update script for hurdcog Debian package
# This script prepares the source package for building
#

set -e

PACKAGE_NAME="hurdcog"
...
if [ ! -d "${SOURCE_DIR}" ]; then
    ...
    echo "Please ensure the hurdcog repository is in the parent directory"
    exit 1
fi
...
echo ""
echo "Note: HurdCog requires cognumach to be installed first"
echo ""
