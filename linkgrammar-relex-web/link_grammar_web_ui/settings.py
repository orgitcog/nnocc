# Django settings for link_grammar_web_ui project.
...
SECRET_KEY = '57017t_ngmlmyo@i2)l2g$-z+7bqbic8706^6h%urta_$487w)'
...
ROOT_URLCONF = 'link_grammar_web_ui.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'link_grammar_web_ui.wsgi.application'
