...
# NOTE: This only works on GCC-compatible compilers (not MSVC)
#
IF (NOT DEFINED LIB_DIR_SUFFIX)
	# Skip this check on Windows/MSVC as -print-search-dirs is not supported
	IF (NOT MSVC AND NOT WIN32)
		EXECUTE_PROCESS(
			COMMAND ${CMAKE_CXX_COMPILER} -print-search-dirs
			OUTPUT_VARIABLE PRINT_SEARCH_DIRS_OUTPUT
			ERROR_QUIET
			RESULT_VARIABLE PRINT_SEARCH_DIRS_RESULT
		)
		IF (PRINT_SEARCH_DIRS_RESULT EQUAL 0 AND PRINT_SEARCH_DIRS_OUTPUT)
