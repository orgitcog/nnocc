...
# Gnu Guile scheme interpreter. Mandatory on Linux/macOS, optional on Windows
...
ELSE (GUILE_FOUND AND GMP_LIBRARY AND GMP_INCLUDE_DIR)
	...
	# On Windows, Guile is not available, so make it a warning instead of fatal error
	IF (WIN32 OR MSVC)
		MESSAGE(WARNING "${GUILE_DIR_MESSAGE}")
		SET(HAVE_GUILE 0)
	ELSE ()
